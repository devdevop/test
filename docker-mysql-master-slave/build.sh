...
priv_stmt1='CREATE USER "mydb_slave_user1"@"%" IDENTIFIED BY "mydb_slave_pwd1"; GRANT REPLICATION SLAVE ON *.* TO "mydb_slave_user1"@"%"; FLUSH PRIVILEGES;'
...
start_slave_stmt="CHANGE MASTER TO MASTER_HOST='mysql_master',MASTER_USER='mydb_slave_user1',MASTER_PASSWORD='mydb_slave_pwd1',MASTER_LOG_FILE='$CURRENT_LOG',MASTER_LOG_POS=$CURRENT_POS; START SLAVE;"
start_slave_cmd='export MYSQL_PWD=111; mysql -u root -e "'
start_slave_cmd+="$start_slave_stmt"
start_slave_cmd+='"'
